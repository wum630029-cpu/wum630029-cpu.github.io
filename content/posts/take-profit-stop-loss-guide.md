...
draft: false
description: '止损单的止损价只是触发开关不是成交价——多数人把止损当成挂个价格，却不知道止损位怎么定、移动止损与追踪止损怎么设、分批止盈与保本止损怎么联动，更不知道止损其实有代价。本文讲透结构位、固定比例与 ATR 波动率适配三种止损位定法，拆解移动止损、追踪止损、分批止盈与盈亏比联动的执行细节，把离场规则落到订单上。'
