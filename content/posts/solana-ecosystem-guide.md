...
3. 🔴 关键步骤：点击「Reveal Recovery Phrase」，你会看到 12 个助记词——用纸笔手动抄写，不要截图、不要存云端、不要发给别人
4. 按顺序验证助记词
5. 完成创建
...
> 🟦 还没有币安账号？[点击注册](https://www.bsmkweb.cc/register?ref=BT123) 输入邀请码 **BT123** 享 20% 手续费返佣。
...
> 📌 **更多学习资源**
> 想看更完整的内容？可看 CoinVado 社区的[Solana 生态](https://coinvado.com/posts/eth-vs-sol-layer1-comparison-2026/)，与本篇图文互为补充；更多教程与最新资讯，欢迎访问 [CoinVado](https://coinvado.com/zh/)。
