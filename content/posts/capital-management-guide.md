...
draft: false
description: '资金管理是交易系统里最容易忽视的短板——很多人单笔止损做得对，却因总敞口过大、持仓高度相关而在一夜之间损失惨重。本文从总敞口控制讲起，系统讲解总风险上限的计算与设定、用相关性矩阵识别伪分散、核心资金与投机资金的账户分仓以及波动率变化时的动态调仓方法，手把手教你建立完整资金管理体系，让账户在极端行情中稳如磐石。'
...
**总风险敞口 = Σ 每笔持仓的潜在风险 = Σ（每笔止损距离 ÷ 入场价 × 仓位价值）**，即把每一笔持仓的潜在风险（用止损距离除以入场价，再乘以仓位价值）加总求和。
