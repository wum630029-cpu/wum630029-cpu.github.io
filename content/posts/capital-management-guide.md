...
单笔风险控制解决的是「单次亏损」，总敞口失控解决的才是「连亏」。回撤是复利的天敌——回撤 20% 要赚 25% 才回本，回撤 40% 要赚 66.7%（回撤的量化与应对详见本站 [最大回撤控制指南](/max-drawdown-control-guide/)）。**总敞口过大，意味着你把自己的账户置于「一次失误＝一次重创」的境地，而这本可以通过总量控制完全避免。**
...
2. **跨方向**：核心持仓 + 少量对冲头寸降低净值波动（低风险对冲的实操可参考本站 [期现套利与资金费率套利](/funding-rate-arbitrage-guide/)）
